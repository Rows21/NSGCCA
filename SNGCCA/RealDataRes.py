...
Score1 = pd.read_csv('C:/Users/Programer/Documents/GitHub/SGCCA_HSIC/tensor1.csv', header=None).iloc[:,0].tolist()
Score2 = pd.read_csv('C:/Users/Programer/Documents/GitHub/SGCCA_HSIC/tensor2.csv', header=None).iloc[:,0].tolist()
Score3 = pd.read_csv('C:/Users/Programer/Documents/GitHub/SGCCA_HSIC/tensor3.csv', header=None).iloc[:,0].tolist()
...
Filter_Exp.iloc[:15,:2].to_csv('Exp_score.csv', index=False)
Filter_Meth.iloc[:15,:2].to_csv('Meth_score.csv', index=False)
Filter_miRNA.iloc[:15,:2].to_csv('miRNA_score.csv', index=False)