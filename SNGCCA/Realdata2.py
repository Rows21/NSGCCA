...
if __name__ == '__main__':
    ...
    for rep in range(1):
        ...
        print(b)
        if device == 'cuda':
            u = solver.SNGCCA.fit_admm(views, constraint=b, logging=1)
        else:
            u = solver.SNGCCA.fit_admm(views, constraint=b, logging=1)
        ...
        df_u1_total.to_csv(root+'/RealData/400/U1.csv')
        df_u2_total.to_csv(root+'/RealData/400/U2.csv')
        df_u3_total.to_csv(root+'/RealData/400/U3.csv')
