...
ggsave('Exp.png',width = 8, height = 6)
tsne_plot(data[[2]],20,0.3,1000)
ggsave('Meth.png',width = 8, height = 6)
tsne_plot(data[[3]],20,0.2,4000)
ggsave('miRNA.png',width = 8, height = 6)
merge <- rbind(data[[2]],data[[3]],data[[1]])
tsne_plot(merge,19,0.3,3000)
ggsave('Merge.png',width = 8, height = 6)
```
...
tsne_plot(data[[1]],37,0.3,2000)
ggsave('Exp_RG.png',width = 8, height = 6)
tsne_plot(data[[2]],20,0.3,1000)
ggsave('Meth_RG.png',width = 8, height = 6)
tsne_plot(data[[3]],12,0.05,4000)
ggsave('miRNA_RG.png',width = 8, height = 6)
merge <- rbind(data[[2]],data[[3]],data[[1]])
tsne_plot(merge,19,0.3,3000)
ggsave('Merge_RG.png',width = 8, height = 6)
```

```{r plot}
data <- list()
respath = paste0(datapath, 'ressg/')
for(i in 1:3){
  Labelpath = paste0(datapath,paste0(file_list[i],'.txt'))
  Datapath = paste0(datapath, paste0(strsplit(file_list[i],'_')[[1]][1],'.txt'))
  Respath = paste0(respath, paste0(data_list[i],"_score.csv"))
...
tsne_plot(data[[1]],37,0.3,2000)
ggsave('Exp_SG.png',width = 8, height = 6)
tsne_plot(data[[2]],20,0.3,1000)
ggsave('Meth_SG.png',width = 8, height = 6)
tsne_plot(data[[3]],12,0.05,4000)
ggsave('miRNA_SG.png',width = 8, height = 6)
merge <- rbind(data[[2]],data[[3]],data[[1]])
tsne_plot(merge,19,0.3,3000)
ggsave('Merge_SG.png',width = 8, height = 6)
```

```{r plot}
data <- list()
respath = paste0(datapath, 'resdg/')
for(i in 1:3){
  Labelpath = paste0(datapath,paste0(file_list[i],'.txt'))
  Datapath = paste0(datapath, paste0(strsplit(file_list[i],'_')[[1]][1],'.txt'))
  Respath = paste0(respath, paste0(data_list[i],"_score.csv"))
...
tsne_plot(data[[1]],37,0.3,2000)
ggsave('Exp_dg.png',width = 8, height = 6)
tsne_plot(data[[2]],20,0.3,1000)
ggsave('Meth_dg.png',width = 8, height = 6)
tsne_plot(data[[3]],12,0.05,4000)
ggsave('miRNA_dg.png',width = 8, height = 6)
merge <- rbind(data[[2]],data[[3]],data[[1]])
tsne_plot(merge,19,0.3,3000)
ggsave('Merge_dg.png',width = 8, height = 6)
```

```{r plot}
data <- list()
respath = paste0(datapath, 'resk/')
for(i in 1:3){
  Labelpath = paste0(datapath,paste0(file_list[i],'.txt'))
  Datapath = paste0(datapath, paste0(strsplit(file_list[i],'_')[[1]][1],'.txt'))
  Respath = paste0(respath, paste0(data_list[i],"_score.csv"))
...
tsne_plot(data[[1]],37,0.3,2000)
ggsave('Exp_K.png',width = 8, height = 6)
tsne_plot(data[[2]],20,0.3,1000)
ggsave('Meth_K.png',width = 8, height = 6)
tsne_plot(data[[3]],12,0.05,4000)
ggsave('miRNA_K.png',width = 8, height = 6)
merge <- rbind(data[[2]],data[[3]],data[[1]])
tsne_plot(merge,19,0.3,3000)
ggsave('Merge_K.png',width = 8, height = 6)
```
