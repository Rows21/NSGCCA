...
sngcca <- as.list(read.csv('D:/GitHub/SNGCCA/SNGCCA/RealData/res5/Exp_score.csv')[1])$Name
...
sngcca <- as.list(read.csv('D:/GitHub/SNGCCA/SNGCCA/RealData/res5/Meth_score.csv')[1])$Name
...
sngcca <- as.list(read.csv('D:/GitHub/SNGCCA/SNGCCA/RealData/res5/miRNA_score.csv')[1])$Name
