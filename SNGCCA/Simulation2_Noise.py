...
if __name__ == '__main__':
    ...
    ## Scenario
        ...
        for N in [20,600,800]:
            print("Scenario=", scenario, "Noise=", N)

            FS = []
            MCC = []
            ACC = []
            views = create_synthData_multi(i=2, data_type=scenario, N=400, p=N, q=N, r=N)
            ...
            ## train hyper
            b0, obj = Solver.tune_hyper(x_list=views, set_params=10, max_params=100, iters=50,logging=1,approx=False)
            print(b0)
