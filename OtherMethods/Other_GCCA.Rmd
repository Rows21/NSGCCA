...
for( i in 1:100){
  if(i %% 10 == 0){print(i)}
  root <- paste0('D:/GitHub/SNGCCA/SNGCCA/Data/Linear/',n,'_',p,'_',v)
  ...
  res1 = rgcca(Data1, method = "rgcca")
  RGCCA_u1[i,] = res1$a[[1]]
  RGCCA_u2[i,] = res1$a[[2]]
  RGCCA_u3[i,] = res1$a[[3]]
  
  #perm_out <- rgcca_permutation(Data1,
  #n_cores = 1,
  #par_type = "tau",
  #n_perms = 50
  #)
  #res2 = rgcca(Data1, connection = 1 - cor_matrix, tau = perm_out$best_params, method = "sgcca")
  #SGCCA_u1[i,] = res2$a[[1]]
  #SGCCA_u2[i,] = res2$a[[2]]
  #SGCCA_u3[i,] = res2$a[[3]]
...
write.csv(RGCCA_u1,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/rgcca_u1.csv"), row.names = FALSE)
write.csv(RGCCA_u2,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/rgcca_u2.csv"), row.names = FALSE)
write.csv(RGCCA_u3,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/rgcca_u3.csv"), row.names = FALSE)
#write.csv(SGCCA_u1,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/sgcca_u1.csv"), row.names = FALSE)
#write.csv(SGCCA_u2,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/sgcca_u2.csv"), row.names = FALSE)
#write.csv(SGCCA_u3,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Linear/',n,'_',p,'_',v,"/sgcca_u3.csv"), row.names = FALSE)
...
for( i in 1:100){
  if(i %% 10 == 0){print(i)}
  root <- paste0('D:/GitHub/SNGCCA/SNGCCA/Data/Nonlinear/',n,'_',p,'_',v)
  X = read.csv(paste0(root,'/data1_',i-1,'.csv'),header = F)
  Y = read.csv(paste0(root,'/data2_',i-1,'.csv'),header = F)
  Z = read.csv(paste0(root,'/data3_',i-1,'.csv'),header = F)
  Data1 = list(X,Y,Z)
...
write.csv(RGCCA_u1,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/rgcca_u1.csv"), row.names = FALSE)
write.csv(RGCCA_u2,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/rgcca_u2.csv"), row.names = FALSE)
write.csv(RGCCA_u3,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/rgcca_u3.csv"), row.names = FALSE)
#write.csv(SGCCA_u1,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/sgcca_u1.csv"), row.names = FALSE)
#write.csv(SGCCA_u2,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/sgcca_u2.csv"), row.names = FALSE)
#write.csv(SGCCA_u3,paste0('D:/GitHub/SNGCCA/SNGCCA/Simulation/Nonlinear/',n,'_',p,'_',v,"/sgcca_u3.csv"), row.names = FALSE)
}
